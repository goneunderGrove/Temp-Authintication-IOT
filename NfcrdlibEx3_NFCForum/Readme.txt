...
=========================================
  ...
  - NfcrdlibEx3_NFCForum can be run with PN5180, PN5190 and PN7462AU.  (See
    Section-16 for supported versions).
...
======================================
  ...
  - For PN7462AU (Section-16 Bullet-2) either of SNEP Client or SNEP Sever can
    be enabled at a time (See Section-8).
  - For PN7462AU (Section-16 Bullet-2) the project should be build only with
...
========================================
  ...
  - If switching between supported NFC Reader boards mention in 16, user is
...
====================================
  ...
  - LPCXpresso LPC1769 / Freedom K82 development boards For NFC ICs listed in
    Section-16 (Note: PN7462AU (Section-16 Bullet-2) does not need any other
...
====================================================================
  ...
  - For MCUXpressio versions before MCUXpressoIDE_11.6.0, See "Adding PN7462AU
    Plugin" in UM10883. (See Section-17, Bullet-3 below)
