...
13 Steps to build NfcrdlibEx8_HCE_T4T for PN76XX using Eclipse
14 Selection of Board / OSAL / Frontend (MCUXpresso)
15 Steps to follow for PI / Linux / CMake
16 Running NfcrdlibEx8_HCE_T4T
...
========================================
  ...
  - NfcrdlibEx8_HCE_T4T can be run with PN5180, PN5190, PN7462AU and PN76XX.
    (See Section-17 for supported versions).
  ...
  - By default CET4T NDEF message mapping version configured to 2.0.
    User need to update this macro to PHCE_T4T_NDEF_SUPPORTED_VNO
    to configure NDEF message mapping version to 3.0.
...
=====================================
  ...
  - This software project requires NxpNfcRdLib v07.07.00 or later.
...
=======================================
  ...
  - This example is written to demonstrate Host Card Emulation feature in
    ...
    Note: To execute NfcrdlibEx8_HCE_T4T with PN76XX refer Section-13.
...
====================================
  ...
  - Plugin to extend MCUXpresso to support PN7462AU. (Required for MCUXpress
    versions before MCUXpressoIDE_11.6.0)

  - LPCXpresso LPC1769 / Freedom K82 development boards For NFC ICs listed in
    Section-17 (Note: PN7462AU (Section-17 Bullet-2) does not need any other
...
========================
  ...
  - Since this example can be configured to run on various MCU ICs and various
    ...
    Section-10, Section-11 and Section-12.  Section-13.
...
===================================================================
  ...
  - For MCUXpressio versions before MCUXpressoIDE_11.6.0, See "Adding PN7462AU
    Plugin" in UM10883. (See Section-18, Bullet-3 below)
...
==============================================================
  ...
  Please refer ReadMe of Eclipse build to compile this application for PN76XX
...
=========================================
  ...
  The steps are described in AN11802. (See Section-18, Bullet-4 below)
